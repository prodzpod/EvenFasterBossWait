...
namespace EvenFasterBossWait
{
    ...
    public class Main : BaseUnityPlugin
    {
        ...
        public static ConfigEntry<float> CompensateKills;
        public static ConfigEntry<float> GeneralScalingCompensation;
        ...
        public void Awake()
        {
            ...
            CompensateKills = Config.Bind("Kills to Time", "Kill Compensation Ratio", 1f, "Time saved by kills multiplied by this amount will be added to run timer.");
            GeneralScalingCompensation = Config.Bind("Kills to Time", "General Scaling Compensation Ratio", 1f, "0: Kill Compensation will account for total time. 1: Kill compensation will only account for time before general scaling is applied.");
